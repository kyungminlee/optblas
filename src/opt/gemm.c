 ...
 */
static void micro_kernel_dgemm(
    int k, 
    double alpha, 
 ...
 * buffer: destination
 */
static void pack_A(int mc, int kc, const double *A, int incRow, int incCol,
            double *buffer) {
...
void dgemm_(char const * ptransa, char const * ptransb, int const * pm, int const * pn, int const * pk, double const * palpha,
              const double * restrict A, int const * plda, const double * restrict B, int const * pldb, double const * pbeta,
              double * restrict C, int const * pldc) {
  my_dgemm(*ptransa, *ptransb, *pm, *pn, *pk, *palpha, A, *plda, B, *pldb, *pbeta, C, *pldc);
}
